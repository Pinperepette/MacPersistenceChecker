...
**[Download MacPersistenceChecker v1.2 (DMG)](https://github.com/Pinperepette/MacPersistenceChecker/releases/download/v1.2/MacPersistenceChecker.dmg)**
...
5. Review items - suspicious items are highlighted
6. Use "Snapshot" to save the current state for future comparison
